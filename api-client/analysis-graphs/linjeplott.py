...
fig_r.savefig("linjeplott_range.pdf", dpi=180, bbox_inches="tight")
fig_c.savefig("linjeplott_cross.pdf", dpi=180, bbox_inches="tight")
plt.show()
print("Lagret: linjeplott_range.pdf, linjeplott_cross.pdf")
